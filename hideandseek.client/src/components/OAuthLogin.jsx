 ...
 * 
 * Provides buttons for users to sign in with Google, Facebook, or Microsoft.
  ...
  return (
    <div className="oauth-login">
      <div className="oauth-header">
        <h2>Sign In to Hide and Seek</h2>
        <p>Choose your preferred sign-in method:</p>
        {forceAccountSelection && (
          <p className="account-selection-notice">
            🔄 You'll be prompted to select an account to ensure you can switch between different accounts.
          </p>
        )}
      </div>
      ...
      <div className="oauth-buttons">
        ...
        >
          ...
          Continue with Google (Select Account)
        </button>
      ...
      <div className="oauth-footer">
        <p className="oauth-disclaimer">
          ...
          We only use your information to provide the noise reporting service.
        </p>
      </div>
    </div>
  );
